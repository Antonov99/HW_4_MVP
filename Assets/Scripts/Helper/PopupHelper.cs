...
namespace Lessons.Architecture.PM
{
    ...
    {
        [FormerlySerializedAs("_characterPopup")]
        [SerializeField]
        private CharacterPopupView characterPopupView;
        ...
        public void ShowPopup()
        {
            ...
            var userPresenter =
                _popupPresenterFactory.CreateUserPresenter(_popupModel.UserInfo, _popupModel.PlayerLevel);
